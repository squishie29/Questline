...
class DestinationController extends Controller
{
     ...
     */
    public function indexFronts(Request $request,DestinationRepository $destinationRepository): Response
    {
        $title = $request->attributes->get('id');
        return $this->render('destination/maps.html.twig', [

            'dest' => $destinationRepository->findBy(
                ['id' => $title]
            ),
        ]);
    }
