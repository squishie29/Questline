...
$catalogue = new MessageCatalogue('hy', array (
  ...
  array (
    ...
    'datatable.datatable.emptyTable' => 'Տվյալները բացակայում են',
    'datatable.datatable.processing' => 'Կատարվում է...',
    'datatable.datatable.infoThousands' => ',',
    'datatable.datatable.lengthMenu' => 'Ցուցադրել _MENU_ արդյունքներ մեկ էջում',
    'datatable.datatable.loadingRecords' => 'Բեռնվում է ...',
    'datatable.datatable.zeroRecords' => 'Հարցմանը համապատասխանող արդյունքներ չկան',
    'datatable.datatable.info' => 'Ցուցադրված են _START_-ից _END_ արդյունքները ընդհանուր _TOTAL_-ից',
    'datatable.datatable.infoEmpty' => 'Արդյունքներ գտնված չեն',
    'datatable.datatable.infoFiltered' => '(ֆիլտրվել է ընդհանուր _MAX_ արդյունքներից)',
    'datatable.datatable.infoPostFix' => '',
    'datatable.datatable.search' => 'Փնտրել',
    'datatable.datatable.paginate.first' => 'Առաջին էջ',
    'datatable.datatable.paginate.previous' => 'Նախորդ էջ',
    'datatable.datatable.paginate.next' => 'Հաջորդ էջ',
    'datatable.datatable.paginate.last' => 'Վերջին էջ',
    'datatable.datatable.aria.sortAscending' => ': ակտիվացրեք աճման կարգով դասավորելու համար',
    'datatable.datatable.aria.sortDescending' => ': ակտիվացրեք նվազման կարգով դասավորելու համար',
  ),
));
