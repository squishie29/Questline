...
class Voyage extends \App\Entity\Voyage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Destination', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Prix', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'Periode', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'guide', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'imageFile', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'imageName', '' . "\0" . 'App\\Entity\\Voyage' . "\0" . 'updatedAt'];
        }
     ...
     * {@inheritDoc}
     */
    public function setPeriode(string $Periode): \App\Entity\Voyage
    {
