...
class __TwigTemplate_2767c32ee7dfd46ab4c9f7439202c8b1c5b3f028e665928453548bc8d271f356 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["notificationList"]) || array_key_exists("notificationList", $context) ? $context["notificationList"] : (function () { throw new RuntimeError('Variable "notificationList" does not exist.', 2, $this->source); })()));
        foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
            // line 3
            echo "    ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["item"], "notification", [], "any", false, false, false, 3), "html", null, true);
            echo "
";
        }
...
{% for item in notificationList %}
    {{ item.notification }}
{% endfor %}
", "@MgiletNotification/notification_list.html.twig", "C:\\wamp64\\www\\devahmed\\vendor\\mgilet\\notification-bundle\\Resources\\views\\notification_list.html.twig");
    }
}
