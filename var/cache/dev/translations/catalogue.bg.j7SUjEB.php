...
$catalogue = new MessageCatalogue('bg', array (
  ...
  array (
    ...
    'datatable.datatable.processing' => 'Обработка на резултатите...',
    'datatable.datatable.lengthMenu' => 'Показване на _MENU_ резултата',
    'datatable.datatable.zeroRecords' => 'Няма намерени резултати',
    'datatable.datatable.info' => 'Показване на резултати от _START_ до _END_ от общо _TOTAL_',
    'datatable.datatable.infoEmpty' => 'Показване на резултати от 0 до 0 от общо 0',
    'datatable.datatable.infoFiltered' => '(филтрирани от общо _MAX_ резултата)',
    'datatable.datatable.infoPostFix' => '',
    'datatable.datatable.search' => 'Търсене:',
    'datatable.datatable.url' => '',
    'datatable.datatable.paginate.first' => 'Първа',
    'datatable.datatable.paginate.previous' => 'Предишна',
    'datatable.datatable.paginate.next' => 'Следваща',
