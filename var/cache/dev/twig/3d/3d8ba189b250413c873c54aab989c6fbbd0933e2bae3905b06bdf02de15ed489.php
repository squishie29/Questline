...
class __TwigTemplate_a35107ccdb8e05dfc4f3af4bddb1544b12c8044f0659d8fc8a61c2088859546d extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        // line 7
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("chart2");
        echo "\">Consulter charte graphique</a>
    <table class=\"table\">
        <thead>
            <tr>
                <th>Id</th>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["review"]) {
            ...
            echo "</td>
                <td>";
            // line 21
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["review"], "comment", [], "any", false, false, false, 21), "html", null, true);
            echo "</td>
                <td>";
            // line 22
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 24
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("review_show", ["id" => twig_get_attribute($this->env, $this->source, $context["review"], "id", [], "any", false, false, false, 24)]), "html", null, true);
            echo "\">show</a>
                    <a href=\"";
            // line 25
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("review_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["review"], "id", [], "any", false, false, false, 25)]), "html", null, true);
            echo "\">edit</a>
                </td>
            </tr>
        ";
...
";
    ...
    {
        return array (  153 => 36,  148 => 33,  139 => 29,  130 => 25,  126 => 24,  121 => 22,  117 => 21,  113 => 20,  110 => 19,  105 => 18,  91 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    <h1>Review index</h1>
    <a href=\"{{ path('chart2') }}\">Consulter charte graphique</a>
    <table class=\"table\">
        <thead>
            <tr>
                <th>Id</th>
...
{% endblock %}
", "review/index.html.twig", "C:\\Users\\asus\\Desktop\\PROJET\\proj\\templates\\review\\index.html.twig");
    }
}
