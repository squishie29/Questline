...
$catalogue = new MessageCatalogue('be', array (
  ...
  array (
    ...
    'datatable.datatable.processing' => 'Пачакайце...',
    'datatable.datatable.lengthMenu' => 'Паказваць _MENU_ запісаў',
    'datatable.datatable.zeroRecords' => 'Запісы адсутнічаюць.',
    'datatable.datatable.info' => 'Запісы з _START_ па _END_ з _TOTAL_ запісаў',
    'datatable.datatable.infoEmpty' => 'Запісы з 0 па 0 з 0 запісаў',
    'datatable.datatable.infoFiltered' => '(адфільтравана з _MAX_ запісаў)',
    'datatable.datatable.infoPostFix' => '',
    'datatable.datatable.search' => 'Пошук:',
    'datatable.datatable.url' => '',
    'datatable.datatable.paginate.first' => 'Першая',
    'datatable.datatable.paginate.previous' => 'Папярэдняя',
    'datatable.datatable.paginate.next' => 'Наступная',
    'datatable.datatable.paginate.last' => 'Апошняя',
    'datatable.datatable.aria.sortAscending' => ': актываваць для сартавання слупка па ўзрастанні',
    'datatable.datatable.aria.sortDescending' => ': актываваць для сартавання слупка па змяншэнні',
  ),
));
